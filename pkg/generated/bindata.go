...
var _controller_pdbYaml = []byte(`apiVersion: policy/v1
...
func controller_pdbYamlBytes() ([]byte, error) {
	return _controller_pdbYaml, nil
}

func controller_pdbYaml() (*asset, error) {
	bytes, err := controller_pdbYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "controller_pdb.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"controller_pdb.yaml":                     controller_pdbYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"controller_pdb.yaml": {controller_pdbYaml, map[string]*bintree{}},
